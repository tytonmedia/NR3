<?php
$url = urldecode($audit_details['site_url']);
?>
<!doctype html>
<html>
  <head>
    ...
    <title>SEO Audit Report Email</title>
    <style>
      /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td colspan="4">Hey There, Someone has sent you an SEO audit report for: {{ $url }}:</td>
                    </tr>
                     <tr>
                      <td>{{ $audit_details['audit_description'] }}</td>
                    </tr>
                    <tr>
                      <td>
                       Health Score: {{ $audit_details['health_score'] }}
                      </td>
                    </tr>
                     <tr>
                      <td>
                       Passed Pages: {{ $audit_details['passed_pages'] }}
                      </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                      <td>
                       Warnings: {{ $audit_details['warnings'] }}
                      </td>
                      </tr>
                       <tr>
                        <td>
